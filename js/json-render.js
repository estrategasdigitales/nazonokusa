...
VIS = {
    ...
    doClick: function(e) {
        ...
        document.getElementById("jsonLocation").innerHTML = path;
    ...
    render: function() {
        ...
        //var json = this.data.input.value;
        //var json = document.getElementById(this.data.input).innerHTML;
        var json = document.getElementById("jsonInput").innerHTML;
        //this.reset();
    ...
    visualize: function(token) {
        ...
        var size = json.length,
            style = PRETTY; //this.data.outHTML.checked ? HTML : PRETTY,
        ...
        document.getElementById(this.data.output).innerHTML = style.display(token, 0);
    ...
    validate: function() {
        ...
        var output, stopped, token, tokenize, unicodeCombiners, unicodeLetters,
            json = document.getElementById("jsonInput").innerHTML,
            cursor = 0,
            eof = (json.length === 0),
            digitStart = /^[\-0-9]$/,
            warnings = [],
